...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            ...
            <select name="bed" class="form-control">
                ...
                <option value="Triple">Ninguno</option>
            </select>
    ...
    <div class="room">
        <?php
        $sql = "SELECT IDE_HAB, TIP_HAB, EST_HAB, NUM_HAB from HABITACION";
        ...
        while ($row = mysqli_fetch_array($re)) {
            echo "<div class='roombox roomboxsuperior'>
						<div class='text-center no-boder'>
                            ...
                            <a href='../roomdelete.php?id=". $row[0] ."'><button class='btn btn-danger'>Cambiar Estado</button></a>
						</div>
                    </div>";/*
            $id = $row[1];
            if ($id == "B") {
